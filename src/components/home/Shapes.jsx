...
const Shapes = () => {
    return (
        <div className='shapes'>
            ...
            <lord-icon
                class="shape s1"
                src="https://cdn.lordicon.com/mtwfhmks.json"
                trigger="loop"
                stroke="bold"
                colors="primary:#d4d1fa,secondary:#ebe6ef,tertiary:#16a9c7"
            ...
            <lord-icon
                class="shape s2"
                src="https://cdn.lordicon.com/njhuvjwd.json"
                trigger="loop"
                stroke="bold"
                colors="primary:#d4d1fa,secondary:#6c16c7"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
            ...
            <lord-icon
                class="shape s3"
                src="https://cdn.lordicon.com/gufmwnag.json"
                trigger="loop"
                colors="primary:#ebe6ef,secondary:#d1e3fa,tertiary:#80a4ed"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
            ...
            <lord-icon
                ...
                stroke="bold"
                state="in calm"
                colors="primary:#80a4ed,secondary:#d4d1fa"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
            ...
            <lord-icon
                ...
                delay="2000"
                stroke="bold"
                colors="primary:#80a4ed,secondary:#d4d1fa,tertiary:#ee66aa,quaternary:#ebe6ef"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
            ...
            <lord-icon
                class="shape s7"
                src="https://cdn.lordicon.com/bzksggsa.json"
                trigger="loop"
                delay="2000"
                colors="primary:#d4d1fa,secondary:#5c0e0a,tertiary:#d1e3fa,quaternary:#d1faf0,quinary:#5c230a"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
            ...
            <lord-icon
                ...
                trigger="loop"
                delay="2000"
                colors="primary:#9cc2f4,secondary:#d1e3fa"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
            ...
            <lord-icon
                class="shape s9"
                src="https://cdn.lordicon.com/yqtiscrh.json"
                trigger="loop"
                delay="2000"
                stroke="bold"
                colors="primary:#80a4ed,secondary:#d1e3fa"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
            ...
            <lord-icon
                class="shape s10"
                src="https://cdn.lordicon.com/cswohhwz.json"
                trigger="loop"
                delay="2000"
                stroke="bold"
                colors="primary:#80a4ed,secondary:#d1e3fa"
            ...
            <lord-icon
                class="shape s11"
                src="https://cdn.lordicon.com/phvrhiqc.json"
                trigger="loop"
                delay="2000"
                colors="primary:#1663c7,secondary:#d1e3fa,tertiary:#9cc2f4"
                style={{width:'45px',height:'45px'}}>
            </lord-icon>
        </div>
    )
